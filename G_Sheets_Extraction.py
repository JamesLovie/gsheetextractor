...
class Gsheets_Extractor:
	...
	def extract_data(self, workbook):
            ...
            npp_data_final = pd.concat([npp_data_final, npp_data], ignore_index=True, sort=False)
...
def main():
    ...
    npp_data_final = extractor.extract_data(workbook)
    print(f'Have extracted {extractor.total_sheets} sheets sucessfully')

    # Call the function save_data.
    extractor.save_data(npp_data_final, 'npp_data_november_2019.csv')
